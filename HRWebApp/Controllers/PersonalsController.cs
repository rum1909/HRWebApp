...
namespace HRWebApp.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        //public ActionResult Index()
        //{
        //    // Lấy danh sách các đối tượng Personal từ cơ sở dữ liệu
        //    var personals = db.Personals.Include(p => p.Benefit_Plans1)
        //                                 .Include(p => p.Emergency_Contacts)
        //                                 .Include(p => p.Employment)
        //                                 .ToList();

        //    // Tạo một danh sách các PersonalViewModel từ danh sách Personal
        //    List<PersonalViewModel> viewModelList = new List<PersonalViewModel>();
        //    foreach (var personal in personals)
        //    {
        //        PersonalViewModel viewModel = new PersonalViewModel
        //        {
        //            // Điền các thuộc tính của PersonalViewModel từ đối tượng Personal
        //            Personal = personal
        //            // Điền các thuộc tính khác ở đây
        //        };

        //        // Thêm PersonalViewModel vào danh sách
        //        viewModelList.Add(viewModel);
        //    }

        //    // Chuyển danh sách PersonalViewModel đến view
        ...
        public ActionResult Edit(decimal id)
        {
            ...
            {
                // Copy các thuộc tính từ Personal sang PersonalViewModel
                Personal = personal
                // Copy các thuộc tính khác ở đây
            };
            ViewBag.Benefit_Plans = new SelectList(db.Benefit_Plans, "Benefit_Plan_ID", "Plan_Name", personal.Benefit_Plans);
            ViewBag.Employee_ID = new SelectList(db.Emergency_Contacts, "Employee_ID", "Emergency_Contact_Name", personal.Employee_ID);
            ViewBag.Employee_ID = new SelectList(db.Employments, "Employee_ID", "Employment_Status", personal.Employee_ID);
